// sebelum itu, ini adalah cara kerja object assignment
const target = { a: 1, b: 5};
const source = { b: 2, c: 3 }; // property source akan menimpa property target apabila ada nama property yang sama

Object.assign(target, source);
console.log(target); // Output: { a: 1, b: 2, c: 3 }
// sourcenya bisa lebih dari 1
